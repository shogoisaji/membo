...
const Duration _dialogSizeAnimationDuration = Duration(milliseconds: 400);
      ...
      return Theme(
        data: Theme.of(context).copyWith(
          colorScheme: const ColorScheme.light(
            primary: MyColor.lightRed,
            onPrimary: MyColor.greenSuperLight,
          ...
          TextButton(
            ...
            child: Text('キャンセル',
                style: lightTextTheme.bodyMedium!
                    .copyWith(color: MyColor.greenText)),
          ),
          ElevatedButton(
            style: ButtonStyle(
              backgroundColor:
                  MaterialStateProperty.all<Color>(MyColor.greenLight),
            ),
            onPressed: _handleOk,
            child: Text('OK',
            ...
            return Column(
              ...
              children: <Widget>[
                Padding(
                  ...
                  child: Center(
                    child: Text(
                        _selectedDate.value!.toIso8601String().toYMDString(),
                        style: lightTextTheme.titleLarge!
                            .copyWith(fontSize: 36, color: MyColor.greenText)),
                  ),
                ),
                Container(
                    color: MyColor.greenLight, child: calendarDatePicker()),
                actions,
              ],
            );
          }),
...
class _DayPickerState extends State<_DayPicker> {
  ...
  void didChangeDependencies() {
    ...
    const DateTime? focusedDate = null;
    if (focusedDate != null &&
